// src/lib.rs
/*
 * Core library for FunnelAnalysis
 */
...
#[derive(Debug)]
pub struct FunnelAnalysisProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FunnelAnalysisProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FunnelAnalysis processing");
    
    let mut processor = FunnelAnalysisProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FunnelAnalysisProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FunnelAnalysisProcessor::new(false);
